...
var _iterDefine = function (Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if ($anyNative) {
    ...
    if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
      ...
      if (!_library && !_has(IteratorPrototype, ITERATOR$4)) _hide(IteratorPrototype, ITERATOR$4, returnThis);
    }
  }
...
function parseUrlParams() {
  ...
  window.history.replaceState(null, '', "?".concat(params).concat(window.location.hash));
}
